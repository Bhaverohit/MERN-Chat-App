                ...
                <Grid item md={6}>
                    <Paper square sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
                        ...
                        <Box sx={{ p: 5 }} component={"form"} onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Typography variant='h4' sx={{ mb: 4, fontWeight: "600", textTransform: "uppercase" }}>Login</Typography>
                            ...
                            <Button type='submit' fullWidth variant='contained' sx={{ py: 1.5 }}>Button</Button>

                            <Box sx={{ display: "flex" }}>
                                <Button fullWidth sx={{ mt: 1, fontSize: "11px" }}>Forgot Password?</Button>
                                <Button fullWidth sx={{ mt: 1, fontSize: "11px" }} onClick={() => navigate("/register")}>Don't have an account?</Button>
                            </Box>
